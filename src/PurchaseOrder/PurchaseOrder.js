...
class PurchaseOrder extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            Customer: null, Customers: [], State: null, States: [], ShipmentPreferences: [], ShipmentPreference: null,
            ...
            <div className="container" style={{ marginTop: '15px' }}>
                ...
                <div className="ContainerStyle formstyle">
                    <div className="col-xs-12">
                        <div className="col-md-2" > <label className="mTop10">Vendor Name </label> </div>
                ...
                <div className="formstyle">
                    <div className="col-xs-12">
                        <div className="col-md-2 mTop10" > <label> Purchase Order # </label> </div>
                        <div className="col-md-3">
                            <div className="form-group">
                                <input className="form-control" type="text" name="purchaseOrder" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xs-12">
                        ...
                        <div className="col-md-2 mTop10" > <label> Date</label> </div>
                        <div className="col-md-3">
                            <div className="form-group">
                        ...
                        <div className="col-md-2 mTop10" > <label> Delivery Date</label> </div>
                        <div className="col-md-3">
                            <div className="form-group">
                    ...
                    <div className="col-xs-12">
                        <div className="col-md-2 mTop10" > <label> Shipment Preference</label> </div>
                            ...
                            <div className="form-group">
                                <div className="input-group">
                                    ...
                                    <Select className="form-control" placeholder="Choose delivery method"
                                        options={this.state.ShipmentPreferences} value={this.state.ShipmentPreference} onChange={this.DeliveryMethodChanged.bind(this)} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="ContainerStyle">
                    ...
                    <div className="col-xs-12" >
                        <div className="col-md-4 mTop10"> <label> Deliver To </label>
